...
public class PushHTMLCommand_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_tvh3j7_a(editorContext, node);
  }
  private EditorCell createCollection_tvh3j7_a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createProperty_tvh3j7_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("property_pushType");
