...
public class VarCommand_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_qhuk1g_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_qhuk1g_d0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createProperty_qhuk1g_d0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
    provider.setRole("id");
