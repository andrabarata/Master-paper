...
public class DBCommands_Behavior {
  ...
  public static List<SNode> call_getNonDupplicates_6352133620898804729(SNode thisNode) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(thisNode, MetaAdapterFactory.getContainmentLink(0x58b9e0aa66634086L, 0x8f84dfaa697f9989L, 0x58274fdf875fd81bL, 0x58274fdf875fd837L, "operations"))).visitAll(new IVisitor<SNode>() {
