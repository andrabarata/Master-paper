package ro.barata.mps.databaseOperationsLanguage;
...
import ro.barata.mps.databaseOperationsLanguage.typesystem.TypesystemDescriptor;
...
public class Language extends LanguageRuntime {
  ...
  public String getNamespace() {
    return "ro.barata.mps.databaseOperationsLanguage";
  }
  ...
  public SLanguageId getId() {
    return new SLanguageId(UUID.fromString("58b9e0aa-6663-4086-8f84-dfaa697f9989"));
  }
  @Override
  protected String[] getExtendedLanguageIDs() {
    return new String[]{"ro.barata.mps.rootLanguage"};
  }
  @Override
  public Collection<TemplateModule> getGenerators() {
    return TemplateUtil.<TemplateModule>asCollection(TemplateUtil.createInterpretedGenerator(this, "c02f1daf-1160-4f41-beef-10918af4e126(ro.barata.mps.databaseOperationsLanguage#7227310691964192368)"));
  }
  @Override
