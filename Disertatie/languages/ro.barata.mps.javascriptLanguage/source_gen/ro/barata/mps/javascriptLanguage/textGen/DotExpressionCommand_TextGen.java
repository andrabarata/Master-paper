...
public class DotExpressionCommand_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    ...
    this.append(".");
    this.append(SPropertyOperations.getString(node, MetaAdapterFactory.getProperty(0xd3ddb860292b4451L, 0x8638cec4e3c81b18L, 0x3ab9167f5c2d22a6L, 0x3ab9167f5c2d22a7L, "expression")));
    this.append(";");
    this.appendNewLine();
  }
}
