...
public class VarCommand_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_qhuk1g_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_qhuk1g_a0(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefNode_qhuk1g_a0(EditorContext editorContext, SNode node) {
