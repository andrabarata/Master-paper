...
public class GetArrayValueCommand_Constraints extends BaseConstraintsDescriptor {
  public GetArrayValueCommand_Constraints() {
    super(MetaIdFactory.conceptId(0xd3ddb860292b4451L, 0x8638cec4e3c81b18L, 0x76145524ee9d3085L));
  }
  @Override
  protected Map<SReferenceLinkId, ReferenceConstraintsDescriptor> getNotDefaultSReferenceLinks() {
    Map<SReferenceLinkId, ReferenceConstraintsDescriptor> references = new HashMap<SReferenceLinkId, ReferenceConstraintsDescriptor>();
    references.put(MetaIdFactory.refId(0xd3ddb860292b4451L, 0x8638cec4e3c81b18L, 0x76145524ee9d3085L, 0x76145524ee9daac5L), new BaseReferenceConstraintsDescriptor(MetaIdFactory.refId(0xd3ddb860292b4451L, 0x8638cec4e3c81b18L, 0x76145524ee9d3085L, 0x76145524ee9daac5L), this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_ab562_a0a0a0a0a1a0b0a1a1;
          }
          @Override
  ...
  private static SNodePointer breakingNode_ab562_a0a0a0a0a1a0b0a1a1 = new SNodePointer("r:bd500181-ba2c-4cc3-b9c2-c902c4a7aea7(ro.barata.mps.javascriptLanguage.constraints)", "3780046886476132163");
}
