...
<language namespace="ro.barata.mps.javascriptLanguage" uuid="d3ddb860-292b-4451-8638-cec4e3c81b18" version="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator name="" generatorUID="ro.barata.mps.javascriptLanguage#3088814217694941832" uuid="2582660f-4a4d-42b3-b567-9d7e54daea92">
      <models>
        <modelRoot contentPath="${module}" type="default">
      ...
      <languageVersions>
        ...
        <language id="d3ddb860-292b-4451-8638-cec4e3c81b18" fqName="ro.barata.mps.javascriptLanguage" version="-1" />
        <language id="5cba771a-86ff-496b-a121-6ae83a039560" fqName="ro.barata.mps.rootLanguage" version="0" />
      </languageVersions>
      <mapping-priorities>
        <mapping-priority-rule kind="strictly_before">
          <greater-priority-mapping>
            <generator generatorUID="2582660f-4a4d-42b3-b567-9d7e54daea92(ro.barata.mps.javascriptLanguage#3088814217694941832)" />
            <external-mapping>
              <all-local-mappings />
            </external-mapping>
          </greater-priority-mapping>
  ...
  <extendedLanguages>
    <extendedLanguage>b9cb18bd-a29f-47d8-9dd0-544a91c4eef2(ro.barata.mps.htmlLanguage)</extendedLanguage>
    <extendedLanguage>58b9e0aa-6663-4086-8f84-dfaa697f9989(ro.barata.mps.databaseOperationsLanguage)</extendedLanguage>
  </extendedLanguages>
</language>
