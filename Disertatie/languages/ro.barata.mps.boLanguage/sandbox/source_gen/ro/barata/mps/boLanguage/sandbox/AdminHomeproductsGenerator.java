...
public class AdminHomeproductsGenerator {
  public static String getContent(HttpSession session, String requestParameterValue) throws ClassNotFoundException, SQLException, CloneNotSupportedException {
    ...
    html += "<script src=\"/" + "adminHomeproducts.js" + "\"></script>";
    ...
    html += " href=\"" + "/" + "addAdminHomeproduct" + href + "\"";
    ...
    {
      List<Product> loop_a1b0_0 = categoryDAO.findChildProducts(null);
      for (int counter_a1b0_0 = 0; counter_a1b0_0 < loop_a1b0_0.size(); counter_a1b0_0++) {
        products = loop_a1b0_0.get(counter_a1b0_0);
        html += "<div";
        href = "";
