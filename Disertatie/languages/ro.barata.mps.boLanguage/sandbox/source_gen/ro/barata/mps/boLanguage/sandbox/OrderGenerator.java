...
public class OrderGenerator {
  public static String getContent(HttpSession session, String requestParameterValue) throws ClassNotFoundException, SQLException {
    ...
    html += "<script src=\"/" + "order.js" + "\"></script>";
...

    {
      ...
      List<Order> loop_b0b1a1a_0 = orderDAO.getAllOrders();
      for (int counter_b0b1a1a_0 = 0; counter_b0b1a1a_0 < loop_b0b1a1a_0.size(); counter_b0b1a1a_0++) {
        order = loop_b0b1a1a_0.get(counter_b0b1a1a_0);
        html += "<tr";
