...
public class OrderServlet extends HttpServlet {
  ...
  private void handleRequest(HttpServletRequest request, HttpServletResponse response) throws IOException, SQLException, ClassNotFoundException {
    ...
    String requestParameterValue = request.getParameter("orderId");
    if (action != null && !(action.equals(""))) {

    } else {
      response.getWriter().println(OrderGenerator.getContent(request.getSession(), requestParameterValue));
    }
  }
}
