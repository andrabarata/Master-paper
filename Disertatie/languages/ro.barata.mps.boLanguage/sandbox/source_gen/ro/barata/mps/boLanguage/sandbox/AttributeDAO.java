...
public class AttributeDAO {
  ...
  public AttributeDAO() throws SQLException, ClassNotFoundException {
  ...
  public List<Attribute> getAllAttributes() throws SQLException {
    ...
    while (set.next()) {
      ...
      foundAttribute.setAttributeName(set.getString("attributeName"));
      foundAttribute.setAttributeValue(set.getString("attributeValue"));
  ...
  public void updateAttribute(Attribute oldattribute, Attribute newattribute) throws SQLException {
