...
public class DAOReferenceMapper_Behavior {
  ...
  public static SNode call_getBelongingMapper_6675303371994802819(final SNode thisNode) {
    ...
    ListSequence.fromList(SModelOperations.nodes(SNodeOperations.getModel(thisNode), MetaAdapterFactory.getConcept(0x5cba771a86ff496bL, 0xa1216ae83a039560L, 0x25b0b61fcc326122L, "ro.barata.mps.rootLanguage.structure.DAOEntityMapper"))).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
