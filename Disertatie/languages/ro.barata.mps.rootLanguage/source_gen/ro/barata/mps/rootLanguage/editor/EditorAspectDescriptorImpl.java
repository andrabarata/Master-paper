...
public class EditorAspectDescriptorImpl implements EditorAspectDescriptor {
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0b = new String[]{"ro.barata.mps.rootLanguage.structure.Attribute", "ro.barata.mps.rootLanguage.structure.BooleanType", "ro.barata.mps.rootLanguage.structure.DatabaseSettings", "ro.barata.mps.rootLanguage.structure.Entity", "ro.barata.mps.rootLanguage.structure.EntityResource", "ro.barata.mps.rootLanguage.structure.EntityType", "ro.barata.mps.rootLanguage.structure.IntType", "ro.barata.mps.rootLanguage.structure.Module", "ro.barata.mps.rootLanguage.structure.SchemaCreator", "ro.barata.mps.rootLanguage.structure.StringType"};
}
